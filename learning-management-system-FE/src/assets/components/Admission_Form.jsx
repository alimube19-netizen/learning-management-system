...
export const Admission_Form = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/api/Admission_Form', formData, {
        headers: {
      ...
      console.log('Admission data saved:', response.data);
    ...
    <div className='admission-form-container'>
      ...
      <div className="page-title-section mb-4">
        ...
        <p className="page-subtitle">
          Complete all sections below to apply for the program.
